...
<header>
    ...
    <section>
        ...
        <form action="" method="post">
            ...
            <input type="submit" onclick="encriptar()" value="Ingresar" style="background-color: #0000ff; ">
        </form>
        <p>
            <?php
                if(isset($correo))
        ...
        <a href="registroUsuario.php" class="opcion" style="background-color: #ff8ccc; padding: 6px 15px;">Registrate</a>
        <a href="productos.php" class="opcion" style="background-color: #ff8ccc; padding: 6px 15px;">Admin</a>
