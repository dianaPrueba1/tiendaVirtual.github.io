...
<body>
    ...
    <!--<nav id="menuPrincipal">
        ...
        <a class="opcionMenu" href="?peticion=registroProductos">Registro Productos</a>
        <a class="opcionMenu" href="?peticion=productos">Catalogo Productos</a>
        <a class="opcionMenu" href="?peticion=cerrarSesion">Cerrar Sesión</a>
    </nav>-->
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link" href="productos.php">Catalogo Productos</a>
        </li>
        <li class="nav-item">
