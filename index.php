...
<body>
    ...
    <div class="card" style="width: 18rem; background-color: #eb38c1;">
    <img src="..." class="card-img-top" alt="...">
    <div class="card-body">
        <h5 class="card-title">Card title</h5>
        <p class="card-text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Inventore, soluta! Possimus corporis nostrum placeat sequi provident optio laboriosam aspernatur ut animi, explicabo reprehenderit? Tempore, pariatur adipisci a doloribus maxime voluptatibus?</p>
        <button class="btn"><a href="?peticion=iniciarSesion">Comprar</a></button>
    </div>
    </div>
